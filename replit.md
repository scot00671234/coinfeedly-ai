# AI Cryptocurrency Price Prediction Platform

## Overview
This platform is a full-stack web application for tracking and analyzing AI model predictions of cryptocurrency prices. It features a minimalist landing page and a comprehensive dashboard where users can compare the accuracy of various AI models (Claude, ChatGPT, Deepseek) in predicting major cryptocurrency prices across quarterly timeframes (3mo, 6mo, 9mo, 12mo). Key capabilities include real-time price tracking from CoinGecko API, interactive charts with timeframe filtering, model performance analytics, and league tables. The project generates comprehensive monthly predictions on the 1st of each month and provides a robust, data-driven tool for assessing AI prediction capabilities in cryptocurrency markets.

## User Preferences
Preferred communication style: Simple, everyday language.

## Recent Changes (January 2025)
- **Cryptocurrency Migration Complete - January 2025**: Complete platform transformation from commodity tracking to cryptocurrency prediction service
- **CoinGecko Integration**: Switched from Yahoo Finance to CoinGecko API for accurate real-time cryptocurrency price data
- **Database Schema Migration**: Updated all tables from commodity references to cryptocurrency structure with proper CoinGecko ID mapping
- **10 Major Cryptocurrencies**: Added Bitcoin, Ethereum, Solana, Cardano, Avalanche, Uniswap, Aave, Compound, Dogecoin, and Shiba Inu
- **Category-Based Organization**: Organized cryptocurrencies by categories (Layer 1, DeFi, Meme coins) for better navigation
- **Real-time Price Updates**: Background price refresh service updating all 10 cryptocurrencies every 5 minutes
- **Historical Price Data**: Added 4,500 historical price data points for comprehensive analysis
...
- **Enhanced AI Services**: Updated OpenAI, Claude, and Deepseek services with quarterly timeframe-specific prediction logic and specialized prompts for long-term cryptocurrency forecasting
...
- **Robust Error Handling**: Fixed critical production issue (42P01 - relation 'cryptocurrencies' does not exist) with multi-layer migration approach
...
- **Cryptocurrency Index Calculation**: Updated composite index to use Layer1/DeFi cryptocurrency indices instead of hard/soft commodity indices
...
- **Real 24-Hour Price Changes - August 2025**: Enhanced CoinGecko service to calculate accurate 24-hour price changes and percentages for all cryptocurrency live price cards, replacing placeholder 0.00% values with actual market data
- **Mobile Compatibility**: Enhanced responsive design across all components for optimal mobile viewing experience
- **Real Accuracy System**: Implemented comprehensive accuracy calculation based on actual AI predictions vs real historical cryptocurrency prices
...
- **Charts**: Recharts for interactive cryptocurrency data visualization
...
- **Schema**: Covers AI models, cryptocurrencies, predictions, actual prices, accuracy metrics, and market alerts.
- **Validation**: Zod schemas for runtime type validation.
- **Storage**: DatabaseStorage class for CRUD operations.
- **Historical Data**: Comprehensive historical AI prediction data for the past year across all cryptocurrencies and models, with intelligent caching.
...
- Compound (COMP) - Lending and borrowing

### Meme Coins
- Dogecoin (DOGE) - Original meme cryptocurrency
- Shiba Inu (SHIB) - Community-driven token

All cryptocurrencies are integrated with CoinGecko for real-time price data and historical analysis.